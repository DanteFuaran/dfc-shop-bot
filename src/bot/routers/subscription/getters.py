    ...
    **kwargs: Any,
    ...
    if subscription:
        ...
        result.update({
            ...
            "device_limit_number": plan_device_limit + extra_devices,
...
async def confirm_yoomoney_getter(
    ...
    **kwargs: Any,
    ...
    return {
        ...
        "device_limit_number": (user.current_subscription.plan.device_limit + (user.current_subscription.extra_devices or 0)) if user.current_subscription else 0,
