...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/DanteFuaran/dfc-shop-bot/main/install.sh) --install
```

### 📦 Что делает скрипт установки
- ✅ Создаёт временную папку в `/tmp` (автоматически удаляется после)
- ✅ Клонирует репозиторий
- ✅ Установит Docker и Docker Compose (если необходимо)
- ✅ Клонирует репозиторий в `/opt/dfc-shop-bot`
