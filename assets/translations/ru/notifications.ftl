...
ntf-db-clear-all-success = 
    ...
    • Операции: <b>{ $transactions }</b>
    • Промокоды: <b>{ $promocodes }</b>
    • Активации промокодов: <b>{ $activations }</b>
    • Рефералы: <b>{ $referrals }</b>
    • Награды рефералов: <b>{ $rewards }</b>
    • Тарифные планы: <b>{ $plans }</b>
    • Периоды планов: <b>{ $plan_durations }</b>
    • Цены планов: <b>{ $plan_prices }</b>
    • Переводы баланса: <b>{ $balance_transfers }</b>
    • Сообщения трансляций: <b>{ $broadcast_messages }</b>
    • Трансляции: <b>{ $broadcasts }</b>
    • Доп. устройства: <b>{ $extra_device_purchases }</b>
    • Способы оплаты: <b>{ $payment_gateways }</b>
    • Настройки: <b>{ $settings }</b>
    </blockquote>
