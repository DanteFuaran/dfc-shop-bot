...
msg-db-clear-users-confirm =
    ...
    <i>Нажмите кнопку ниже для подтверждения.</i>

msg-db-clear-users-confirm-final =
    <b>⚠️ ПОСЛЕДНЕЕ ПОДТВЕРЖДЕНИЕ!</b>

    <blockquote>
    Вы действительно уверены? Это удалит ВСЕ пользователи и связанные данные!
    
    Это действие <b>НЕВОЗМОЖНО ОТМЕНИТЬ</b>.
    </blockquote>

    <i>Нажмите кнопку "Очистить пользователей" повторно для окончательного удаления.</i>

msg-db-clear-users-success =
    <b>✅ Пользователи успешно удалены!</b>
    ...
    • Активаций промокодов: { $activations }
    • Рефералов: { $referrals }
    • Наград: { $rewards }
    </blockquote>
